...
<template>
  <div
    data-toybaco-conversation-card
    :data-has-meta="Boolean(showMetaSection)"
  ...
  >
    ...
    >
      <Avatar
        v-if="!hideThumbnail"
        data-toybaco-conversation-avatar
    ...
    <div
      data-toybaco-conversation-content
      class="px-0 py-3 flex-1 min-w-0 border-line"
    >
      <div
      ...
      >
        <InboxName
          v-if="showInboxName"
          data-toybaco-conversation-inbox
          :inbox="inbox"
      ...
      <VoiceCallStatus
        ...
        data-toybaco-conversation-preview
      ...
      <div
        data-toybaco-conversation-activity
