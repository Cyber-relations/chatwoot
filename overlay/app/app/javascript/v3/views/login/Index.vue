...
import { getNotificationConversationURL } from '../../helpers/AuthHelper';
...
export default {
  ...
  methods: {
    ...
    handleMfaVerified(payload) {
      // MFA verification successful, continue with login
      this.handleImpersonation();
      window.location =
        (!this.ssoAuthToken && !this.ssoAccountId && !this.ssoConversationId
          ? getNotificationConversationURL(payload?.data)
          : '') || '/app';
    },
    handleMfaCancel() {
