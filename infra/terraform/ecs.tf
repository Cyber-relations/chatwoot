...
locals {
  app_environment = [
    ...
    { name = "LOGO", value = "/brand-assets/toybaco-logo-c4.png?v=ivory-20260914" },
    { name = "LOGO_DARK", value = "/brand-assets/toybaco-logo-c4-dark.png?v=ivory-20260914" },
    { name = "LOGO_THUMBNAIL", value = "/brand-assets/toybaco-app-icon-ivory.png" },
